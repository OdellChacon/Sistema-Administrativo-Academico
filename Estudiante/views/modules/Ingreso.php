		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-right">
					<h5>"La perfección no es alcanzable, pero si perseguimos la perfección podemos conseguir la excelencia"<hr> - Vince Lombardi.</h5><hr>
					<a href="../Registro/index.php"><button type="button" class="btn btn-success">Registrarme</button></a>
				</div>
			</div>
		</div>
	</form>
