...
<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Actualizar Datos <small>[Estudiantes]</small></h2>
                    <form method="POST">
						...
						<div class="row row-space">
							<div class="col-2">
                                <div class="input-group">
								<input class="input--style-1" type="text" name="Pais" value="<?php echo $Usuario["Pais"] ?>" placeholder="Pais De Nacimiento">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
									<input class="input--style-1"  type="text" name="Estado" value="<?php echo $Usuario["Estado"] ?>" placeholder="Estado De Nacimiento">										</div>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
									<input class="input--style-1"  type="text" name="Ciudad" value="<?php echo $Usuario["Ciudad"] ?>" placeholder="Estado De Nacimiento">										
								</div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
										...
										<input type="hidden" value="<?php echo $Usuario["id_estudiante"] ?>" name="id_estudiante">
                                    </div>
                                </div>
                            </div>
                        </div>
