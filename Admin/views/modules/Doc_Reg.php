                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
								<h6 style="text-decoration:underline;">Nivel Educativo</h6>
								<select name="Nivel_Educacion">
										...
										<option>Educacion Universitaria</option>
									</select>                       
									<div class="select-dropdown"></div>
								</div>
                            </div>
						...
						<?php
							...
							$envio_datos = Registro_Ctr::Envio_Datos_DOC();
								...
								window.location = "index.php?action=Lista_Docentes";
